...
execute as @initiator[scores={Moneyz=1000..},tag=!d4002] run tag @s add tmp

execute as @initiator[scores={Moneyz=1000..},tag=!d4002,tag=tmp] run scoreboard players remove @s Moneyz 1000

execute as @initiator[tag=!d4002,tag=tmp] run tag @s add d4002

execute as @initiator[tag=d4002,tag=tmp] run tag @s remove tmp
