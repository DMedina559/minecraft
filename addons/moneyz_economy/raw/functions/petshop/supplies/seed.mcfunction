execute as @initiator[scores={Moneyz=..14}] run tell @s §cYou can't buy 5 Seeds!

execute as @initiator[scores={Moneyz=..14}] run tellraw @s {"rawtext": [{"text": "§cYou need 15 Moneyz for this purchase\n"}, {"text": "§6You have "}, {"score":{"name": "@s","objective": "Moneyz"}}, {"text": " Moneyz"}]}

execute as @initiator[scores={Moneyz=15..}] run tell @s §aYou can buy 5 Seeds!

execute as @initiator[scores={Moneyz=15..}] run give @s wheat_seeds 5

execute as @initiator[scores={Moneyz=15..}] run tell @s §aPurchased 5 Seeds!
