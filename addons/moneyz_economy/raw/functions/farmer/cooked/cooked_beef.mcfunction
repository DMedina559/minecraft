...
execute as @initiator[scores={Moneyz=..44}] run tell @s §cYou can't buy 5 Cooked Beefs!
...
execute as @initiator[scores={Moneyz=45..}] run tell @s §aYou can buy 5 Cooked Beefs!

execute as @initiator[scores={Moneyz=45..}] run give @s cooked_beef 5 

execute as @initiator[scores={Moneyz=45..}] run tell @s §aPurchased 5 Cooked Beefs!
