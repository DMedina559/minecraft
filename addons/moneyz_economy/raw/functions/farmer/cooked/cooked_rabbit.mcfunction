...
execute as @initiator[scores={Moneyz=..29}] run tell @s §cYou can't buy 5 Cooked Rabbits!
...
execute as @initiator[scores={Moneyz=30..}] run tell @s §aYou can buy 5 Cooked Rabbits!

execute as @initiator[scores={Moneyz=30..}] run give @s cooked_rabbit 5 

execute as @initiator[scores={Moneyz=30..}] run tell @s §aPurchased 5 Cooked Rabbits!
