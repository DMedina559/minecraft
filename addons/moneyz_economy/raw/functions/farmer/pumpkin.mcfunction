...
execute as @initiator[scores={Moneyz=..4}] run tell @s §cYou can't buy a Pumpkin!
...
execute as @initiator[scores={Moneyz=5..}] run tell @s §aYou can buy a Pumpkin!

execute as @initiator[scores={Moneyz=5..}] run give @s pumpkin 1

execute as @initiator[scores={Moneyz=5..}] run tell @s §aPurchased a Pumpkin!
