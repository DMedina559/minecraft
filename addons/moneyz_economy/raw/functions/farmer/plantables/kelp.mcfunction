...
execute as @initiator[scores={Moneyz=..4}] run tell @s §cYou can't buy 5 Kelp!
...
execute as @initiator[scores={Moneyz=5..}] run tell @s §aYou can buy 5 Kelp!

execute as @initiator[scores={Moneyz=5..}] run give @s kelp 5

execute as @initiator[scores={Moneyz=5..}] run tell @s §aPurchased 5 Kelp!
