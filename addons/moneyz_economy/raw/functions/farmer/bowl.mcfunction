...
execute as @initiator[scores={Moneyz=..4}] run tell @s §cYou can't buy a Bowl!
...
execute as @initiator[scores={Moneyz=5..}] run tell @s §aYou can buy a Bowl!

execute as @initiator[scores={Moneyz=5..}] run give @s bowl 1

execute as @initiator[scores={Moneyz=5..}] run tell @s §aPurchased a Bowl!
