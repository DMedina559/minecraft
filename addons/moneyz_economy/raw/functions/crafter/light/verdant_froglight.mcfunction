...
execute as @initiator[scores={Moneyz=..44}] run tell @s §cYou can't buy 15 Verdant Froglights!
...
execute as @initiator[scores={Moneyz=45..}] run tell @s §aYou can buy 15 Verdant Froglights!

execute as @initiator[scores={Moneyz=45..}] run give @s verdant_froglight 15 

execute as @initiator[scores={Moneyz=45..}] run tell @s §aPurchased 15 Verdant Froglights!
