...
tellraw @s {"rawtext": [{"text": "§r§eWorld Owners/Admins §rshould address their §lResidential Buildings §rto §l§efollow the addresses provided in the pack (i.e W1001).\n"}]}
...
tellraw @s {"rawtext": [{"text": "§r§eWorld Owners/Admins §rshould §lconstruct a Jail §rto §l§eallow Cops a place of operations.\n"}]}
...
tellraw @s {"rawtext": [{"text": "§r§eWorld Owners/Admins §rshould construct a §lCommunity Center §rto §l§eallow Players a place to sell their goods to other Players, allow a Court system, allow the Mayor a place to plan events for the community, and to allow a place for Pastors to spread as much fear as possible.\n"}]}
