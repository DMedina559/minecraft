...
execute as @initiator[scores={Moneyz=..499}] run tell @s §cYou can't buy a Trident!
...
execute as @initiator[scores={Moneyz=500..}] run tell @s §aYou can buy a Trident!

execute as @initiator[scores={Moneyz=500..}] run structure load armory:trident ~ ~ ~

execute as @initiator[scores={Moneyz=500..}] run tell @s §aPurchased a Trident!
