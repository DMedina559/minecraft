...
execute as @initiator[scores={Moneyz=..9}] run tell @s §cYou can't buy 5 Oak Logs!
...
execute as @initiator[scores={Moneyz=10..}] run tell @s §aYou can buy 5 Oak Logs!

execute as @initiator[scores={Moneyz=10..}] run give @s oak_log 5

execute as @initiator[scores={Moneyz=10..}] run tell @s §aPurchased 5 Oak Logs!
